...
final class AuthManager {
    ...
    private static let bgTaskID = "com.khm.KhmNow.tokenRefresh"

    init(api: NVIDIAAuthAPI = NVIDIAAuthAPI()) {
        self.api = api
    }
    ...
    func login(with provider: LoginProvider? = nil) {
        ...
        loginTask = Task {
            ...
            do {
                ...
                let selectedProvider = providers.first { $0.code == "BPC" } ?? providers.first ?? LoginProvider(
